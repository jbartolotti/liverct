...
parser.add_argument("--include-secondary", action="store_true", help="Include PRIMARY and SECONDARY review selections")
...
manifest = build_manifest(args.inventory, args.review, args.output, load_config(args.config), include_secondary=args.include_secondary)
